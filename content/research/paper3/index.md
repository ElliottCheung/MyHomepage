...
author: ["Silin Du","[Xiaowei (Elliott) Zhang](/MyHomepage)"]
source: "<b>First Conference on Language Modeling (COLM '24)</b>"
...
editPost:
    ...
    Text: "First Conference on Language Modeling (COLM '24)"
...
Du, S. and Zhang, X., (2024). Helmsman of the masses? evaluate the opinion leadership of large language models in the werewolf game. *First Conference on Language Modeling (COLM '24)*, Philadelphia, PA, October 7-9, 2024. https://arxiv.org/abs/2404.01602.

```latex
@misc{du2024helmsmanmassesevaluateopinion,
      title={Helmsman of the Masses? Evaluate the Opinion Leadership of Large Language Models in the Werewolf Game}, 
